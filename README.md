...
docker tag nginx:alpine alpineasi:latest

docker tag SOURCE_IMAGE[:TAG] reg.savvyminds.dev:8080/asitest/REPOSITORY[:TAG]

docker push alpineasi:latest reg.savvyminds.dev/asitest/alpineasi:latest
docker push reg.savvyminds.dev:8080/asitest/REPOSITORY[:TAG]
